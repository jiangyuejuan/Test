<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberDetail.aspx.cs" Inherits="Zenga.Web.MemberDetail" %>
                                ...
                                <div class="box-body Voucher_dl">
                                    <table class="table table_no_border">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>姓名:</th>
                                                <td>&nbsp;<asp:Label ID="lblVoucherFaceAmount" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 90px;">确认姓名:</th>
                                                <td>
