<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportStore.aspx.cs" Inherits="Zenga.Web.Admin.ImportStore" %>
                                    ...
                                    <div class="box-tools">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="input-group pull-right" style="width: 210px; margin-left: 10px;"><asp:FileUpload ID="FileUpload1" runat="server" />
                                                </div>
                                            </div>
                                        </div>
